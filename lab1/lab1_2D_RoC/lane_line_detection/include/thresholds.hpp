...
void abs_sobel_thresh(cv::Mat &src, cv::Mat &dst, char orient, int sobel_kernel, int thresh_min,
                      int thresh_max);
...
void sobel_mag_dir_thresh(cv::Mat &src, cv::Mat &mag, cv::Mat &angle, int sobel_kernel,
                         int mag_thresh_min, int mag_thresh_max, float dir_thresh_min,
                         float dir_thresh_max);
