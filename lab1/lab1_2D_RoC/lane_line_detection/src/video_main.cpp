...
int main(int argc, char *argv[])
{
    ...
    cv::Mat undistorted, transformed, thresholded, dst, summed, best_fit_l, best_fit_r;
    ...
    while (true) {
        ...
        try {
            ...
            window_search(thresholded, output, lane_lines, peaks,  9, 100, 75, fitx1, ploty1, fitx2, final_result_img, best_fit_l, best_fit_r);
